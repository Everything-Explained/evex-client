...
const uri: DataCacheArrayKeys = 'videos/red33m-archive';
const version = useAPI().state.versions?.r3dArch.v;
if (!version) {
...
const title = computed(() => activePage.value?.data?.title || 'RED33M Archive');
